...
| 天 | 类型 | 主题 |
|----|------|------|
| [Day 1（周一）](./day01.md) | 概念入门 | FastAPI 入门 |
| [Day 2（周二）](./day02.md) | 源码阅读 | 多模型 /chat 接口 |
| [Day 3（周三）](./day03.md) | 编码练习 | Pydantic 请求验证 |
| [Day 4（周四）](./day04.md) | 架构理解 | 错误处理与 API Key |
| [Day 5（周五）](./day05.md) | 类比日 | 类比日与测试 |
| [Day 6（周六）](./day06.md) | 项目实战 | LLM Gateway 交付 |
