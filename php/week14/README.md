...
| 天 | 类型 | 主题 |
|----|------|------|
| [Day 1（周一）](./day01.md) | 概念入门 | MCP 协议概述 |
| [Day 2（周二）](./day02.md) | 源码阅读 | 现有 MCP Server 源码 |
| [Day 3（周三）](./day03.md) | 编码练习 | 新增 dev 只读 Tool |
| [Day 4（周四）](./day04.md) | 架构理解 | Cursor MCP 集成 |
| [Day 5（周五）](./day05.md) | 类比日 | 安全规范与类比日 |
| [Day 6（周六）](./day06.md) | 项目实战 | MCP 交付项目 |
