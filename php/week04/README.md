...
| 天 | 类型 | 主题 |
|----|------|------|
| [Day 1（周一）](./day01.md) | 概念入门 | g_config 函数 |
| [Day 2（周二）](./day02.md) | 源码阅读 | 配置 API 全链路 |
| [Day 3（周三）](./day03.md) | 编码练习 | 配置中心概念 |
| [Day 4（周四）](./day04.md) | 架构理解 | Laravel 对比 |
| [Day 5（周五）](./day05.md) | 类比日 | 阶段总结与类比日 |
| [Day 6（周六）](./day06.md) | 项目实战 | 配置项清单项目 |
| [Day 7（周日）](./day07.md) | 复盘预习 | 阶段①验收 |
