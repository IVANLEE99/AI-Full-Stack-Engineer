...
| 天 | 类型 | 主题 |
|----|------|------|
| [Day 1（周一）](./day01.md) | 概念入门 | LangGraph 入门 |
| [Day 2（周二）](./day02.md) | 源码阅读 | PHP Node 链复习 |
| [Day 3（周三）](./day03.md) | 编码练习 | 编排模式对比 |
| [Day 4（周四）](./day04.md) | 架构理解 | 售后 Node 链 |
| [Day 5（周五）](./day05.md) | 类比日 | 阶段总结与类比日 |
| [Day 6（周六）](./day06.md) | 项目实战 | 编排模式交付 |
