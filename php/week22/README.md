...
| 天 | 类型 | 主题 |
|----|------|------|
| [Day 1（周一）](./day01.md) | 概念入门 | Vue3 对话 UI |
| [Day 2（周二）](./day02.md) | 源码阅读 | PHP 薄 API 层 |
| [Day 3（周三）](./day03.md) | 编码练习 | MCP 集成 |
| [Day 4（周四）](./day04.md) | 架构理解 | RAG 集成 |
| [Day 5（周五）](./day05.md) | 类比日 | 联调与类比日 |
| [Day 6（周六）](./day06.md) | 项目实战 | MVP 演示 |
