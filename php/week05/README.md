...
| 天 | 类型 | 主题 |
|----|------|------|
| [Day 1（周一）](./day01.md) | 概念入门 | BFF 模式与网关职责 |
| [Day 2（周二）](./day02.md) | 源码阅读 | HTTP 客户端封装 |
| [Day 3（周三）](./day03.md) | 编码练习 | 薄 Controller 实践 |
| [Day 4（周四）](./day04.md) | 架构理解 | 鉴权、公参与反查链路 |
| [Day 5（周五）](./day05.md) | 类比日 | Laravel 对比与类比日 |
| [Day 6（周六）](./day06.md) | 项目实战 | 结账 API 路由表项目 |
