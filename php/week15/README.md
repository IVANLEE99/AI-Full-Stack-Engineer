...
| 天 | 类型 | 主题 |
|----|------|------|
| [Day 1（周一）](./day01.md) | 概念入门 | Agent 架构设计 |
| [Day 2（周二）](./day02.md) | 源码阅读 | MCP Tool 集成 |
| [Day 3（周三）](./day03.md) | 编码练习 | System Prompt 工程 |
| [Day 4（周四）](./day04.md) | 架构理解 | 多场景路由 |
| [Day 5（周五）](./day05.md) | 类比日 | 错误处理与类比日 |
| [Day 6（周六）](./day06.md) | 项目实战 | 客服 Agent Demo |
