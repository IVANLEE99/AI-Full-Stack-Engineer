...
| 天 | 类型 | 主题 |
|----|------|------|
| [Day 1（周一）](./day01.md) | 概念入门 | Yii2 入口与启动 |
| [Day 2（周二）](./day02.md) | 源码阅读 | Module 与路由 |
| [Day 3（周三）](./day03.md) | 编码练习 | behaviors 与 Filter |
| [Day 4（周四）](./day04.md) | 架构理解 | BaseForm 校验 |
| [Day 5（周五）](./day05.md) | 类比日 | Laravel 对比与类比日 |
| [Day 6（周六）](./day06.md) | 项目实战 | 鉴权白名单与路径图 |
