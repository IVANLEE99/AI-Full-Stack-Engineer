...
| 天 | 类型 | 主题 |
|----|------|------|
| [Day 1（周一）](./day01.md) | 概念入门 | MySQL 与索引基础 |
| [Day 2（周二）](./day02.md) | 源码阅读 | ActiveRecord 模型 |
| [Day 3（周三）](./day03.md) | 编码练习 | Repository 模式 |
| [Day 4（周四）](./day04.md) | 架构理解 | Redis 缓存 |
| [Day 5（周五）](./day05.md) | 类比日 | N+1 与类比日 |
| [Day 6（周六）](./day06.md) | 项目实战 | 订单 ER 图实战 |
